...
<body>
	...
	<center>
		<div style=" background-color: #5F9EA0;width: 30%; align-items: center;">
            ...
            ?>
			<form class="formgroup" action="dbconnect.php" method="POST" style="box-shadow: 5px 5px 10px black; width: 100%; background-color: white; padding: 14px;">
				<h3 style="background-color: grey; color: white;">Dhow Booking Management System</h3>
